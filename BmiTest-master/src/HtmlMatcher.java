...
public class HtmlMatcher {
	...
	private String searchKeyword; // keyword ���afe.wifi.MRT....敺Google���雯������葡
	private String searchKeyword2; // keyword �靘Google����摮
	public static ArrayList<WebPage> web; // Google���������雯���
	...
	public HtmlMatcher(String kind, String searchKeyword) throws IOException {
		...
		web = new ArrayList<>();
		{
			if (searchKeyword != "movie") {
				this.searchKeyword = searchKeyword + "+movie";
			}

		}
		query(); // search google
		fetchRelatedKeyword(); // ���oogle����摮�
	}
	...
	public void fetchRelatedKeyword() throws IOException {
		this.url = "https://www.google.com.tw/search?q=" + searchKeyword2 + "review" + "&oe=utf8num=10";
